...
A continuación se proporciona una pequeña guia de la instalación de SQL en linux:
...
Para no crear una base de datos desde cero necesitamos importar una pero antes de eso vamos a descargar la base de datos **chinook** desde su repositorio de github.
...
En el siguiente post veremos el uso fundamental desde la consola de las bases de datos, realizar todo tipo de consultas, etc.
